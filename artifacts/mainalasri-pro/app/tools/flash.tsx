...
const styles = StyleSheet.create({
  ...
  cardName: { fontSize: 15, fontFamily: "Inter_600SemiBold", textAlign: "right" },
  cardBrand: { fontSize: 12, fontFamily: "Inter_500Medium", textAlign: "right" },
  ...
  modeCombo: { fontSize: 11, fontFamily: "Inter_400Regular", textAlign: "center" },
  warnCard: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 8, padding: 12, borderRadius: 12, borderWidth: 1, marginTop: 6 },
  warnText: { flex: 1, fontSize: 13, fontFamily: "Inter_500Medium", textAlign: "right", lineHeight: 19 },
});
