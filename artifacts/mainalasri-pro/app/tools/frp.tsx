...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 12, fontWeight: "600", textAlign: "right", marginTop: 8, marginBottom: 4, textTransform: "uppercase" },
  ...
  stepDesc: { fontSize: 13, textAlign: "right", marginTop: 6, lineHeight: 20 },
  tipRow: {
